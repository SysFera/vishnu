...
public:
   ...
   */
  virtual int
  chgrp(const std::string& group) = 0;
   ...
   */
  virtual int
  mkfile(const mode_t mode=defaultFileAccessMode) = 0;
   ...
   */
  static int
  getDirEntryFrom( const std::string& rawFileStat, FMS_Data::DirEntry* dirEntry);
...
protected:
   ...
   */
  void
  setOwner(const std::string& owner) const;
   ...
   */
  void
  setGroup(const std::string& group) const;
   ...
   */
  void
  setPerms(const mode_t perms) const;
   ...
   */
  void
  setSize(const file_size_t size) const;
   ...
   */
  void
  setAtime(const time_t atime) const;
   ...
   */
  void
  setMtime(const time_t mtime) const;
   ...
   */
  void
  setCtime(const time_t ctime) const;
   ...
   */
  void
  setType(const file_type_t type) const;
