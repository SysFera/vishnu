...
int
FileTransferProxy::addCpThread(const CpFileOptions& options){
...
int FileTransferProxy::stopThread(const StopTransferOptions& options) {
  ...
  std::string optionsToString =  _ser.serialize_str(const_cast<FMS_Data::StopTransferOptions_ptr>(&options));
