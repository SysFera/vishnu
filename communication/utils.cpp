...
JsonObject::serialize(const TMS_Data::Job& job, int flag) {
  ...
  jsonProfile.setProperty("machine", job.getMachine());
  jsonProfile.setProperty("jobid", job.getId());
  jsonProfile.setProperty("workid", job.getWorkId());
  jsonProfile.setProperty("jobname", job.getName());
  jsonProfile.setProperty("batchjobid", job.getBatchJobId());
  jsonProfile.setProperty("jobpath", job.getPath());
  ...
  jsonProfile.setProperty("jobworkingdir", job.getWorkingDir());
  ...
  jsonProfile.setProperty("owner", job.getLocalAccount());
  jsonProfile.setProperty("jobqueue", job.getQueue());
  jsonProfile.setProperty("wallclocklimit", job.getWallClockLimit());
  jsonProfile.setProperty("groupname", job.getGroupName());
  jsonProfile.setProperty("description", job.getDescription());
...
TMS_Data::Job JsonObject::getJob() {
  ...
  job.setMachine(getStringProperty("machine"));
  job.setId(getStringProperty("jobid"));
  job.setName(getStringProperty("jobname"));
  job.setBatchJobId(getStringProperty("batchjobid"));
  job.setPath(getStringProperty("jobpath"));
