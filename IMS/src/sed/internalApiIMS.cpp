...
solveExport(diet_profile_t* pb){
  ...
  try {
    ...
    diet_string_set(pb,4, content.c_str());
    diet_string_set(pb,5, retErr.c_str());
...
solveCurMetric(diet_profile_t* pb){
  ...
  diet_string_get(pb,0, sessionKey);
  diet_string_get(pb,1, mid);
  diet_string_get(pb,2, curOpSer);
  ...
  try {
    ...
    // Setting out diet param
    diet_string_set(pb,3, curSer.c_str());
...
solveOldMetric(diet_profile_t* pb){
  ...
  diet_string_get(pb,0, sessionKey);
  diet_string_get(pb,1, mid);
  diet_string_get(pb,2, histOpSer);
  ...
  try {
    ...
    // Setting out diet param
    diet_string_set(pb,3, histSer.c_str());
    diet_string_set(pb,4, retErr.c_str());
...
solvePS(diet_profile_t* pb){
  ...
  diet_string_get(pb,0, sessionKey);
  diet_string_get(pb,1, processOpSer);
  ...
  try {
    ...
    // Setting out diet param
    diet_string_set(pb,2, processSer.c_str());
...
solveGetThreshold(diet_profile_t* pb){
  ...
  try {
    ...
    // Setting out diet param
    diet_string_set(pb,2, treeSer.c_str());
    diet_string_set(pb,3, retErr.c_str());
...
solveGetUpFreq(diet_profile_t* pb){
  ...
  try {
    ...
    // Setting out diet param
    diet_string_set(pb,1, convertToString(res).c_str());
    diet_string_set(pb,2, retErr.c_str());
...
solveGetSysInfo(diet_profile_t* pb){
  ...
  try {
    ...
    // Setting out diet param
    diet_string_set(pb,2, sysSer.c_str());
    diet_string_set(pb,3, retErr.c_str());
