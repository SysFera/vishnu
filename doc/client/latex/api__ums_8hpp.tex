...
int \hyperlink{namespacevishnu_ac7cd83030f8f6e990001b238a9f50640}{vishnu::addUser} (const std::string \&sessionKey, \hyperlink{classUMS__Data_1_1User}{UMS\_\-Data::User} \&newUser)  throw (UserException, SystemException)
\begin{DoxyCompactList}\small\item\em Function to add a new user in VISHNU. \item\end{DoxyCompactList}\item 
int \hyperlink{namespacevishnu_a1446b24fda1ed0ca910686635b6bb956}{vishnu::updateUser} (const std::string \&sessionKey, const \hyperlink{classUMS__Data_1_1User}{UMS\_\-Data::User} \&user)  throw (UserException, SystemException)
...
int \hyperlink{namespacevishnu_aca4f5c2716ce1dd8ddc15a2554c95004}{vishnu::addMachine} (const std::string \&sessionKey, \hyperlink{classUMS__Data_1_1Machine}{UMS\_\-Data::Machine} \&newMachine)  throw (UserException, SystemException)
\begin{DoxyCompactList}\small\item\em Function to add a new machine in VISHNU. \item\end{DoxyCompactList}\item 
int \hyperlink{namespacevishnu_a1f8fe4e8fa5956be1f264e9a5f78c9f1}{vishnu::updateMachine} (const std::string \&sessionKey, const \hyperlink{classUMS__Data_1_1Machine}{UMS\_\-Data::Machine} \&machine)  throw (UserException, SystemException)
...
int \hyperlink{namespacevishnu_ab54431ee8c1616ae24b071e9146d39e9}{vishnu::addLocalAccount} (const std::string \&sessionKey, const \hyperlink{classUMS__Data_1_1LocalAccount}{UMS\_\-Data::LocalAccount} \&newLocalAccount, std::string \&sshPublicKey)  throw (UserException, SystemException)
\begin{DoxyCompactList}\small\item\em Function to add a new local user configuration. \item\end{DoxyCompactList}\item 
int \hyperlink{namespacevishnu_ac51341ab58c1ed606b254262fbc053dc}{vishnu::updateLocalAccount} (const std::string \&sessionKey, const \hyperlink{classUMS__Data_1_1LocalAccount}{UMS\_\-Data::LocalAccount} \&localAccount)  throw (UserException, SystemException)
...
int \hyperlink{namespacevishnu_a2ecc54aee4da202b1caa94dfa6a43d17}{vishnu::saveConfiguration} (const std::string \&sessionKey, \hyperlink{classUMS__Data_1_1Configuration}{UMS\_\-Data::Configuration} \&config)  throw (UserException, SystemException)
