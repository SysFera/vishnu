...
\hypertarget{classVishnuException_a329095015a92f306599007ae27d836c1}{
\index{VishnuException@{VishnuException}!operator=@{operator=}}
\index{operator=@{operator=}!VishnuException@{VishnuException}}
\subsubsection[{operator=}]{\setlength{\rightskip}{0pt plus 5cm}{\bf VishnuException}\& VishnuException::operator= (
\begin{DoxyParamCaption}
\item[{const {\bf VishnuException} \&}]{ e}
\end{DoxyParamCaption}
)}}
\label{classVishnuException_a329095015a92f306599007ae27d836c1}
...
\begin{DoxyParams}{Parameters}
\item[{\em e}]the object to assign \end{DoxyParams}
\begin{DoxyReturn}{Returns}
the object exception with the new values 
\end{DoxyReturn}
