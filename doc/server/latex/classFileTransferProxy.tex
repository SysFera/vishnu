...
\begin{DoxyParams}{Parameters}
\item[{\em sessionKey}]The session key \item[{\em srcFilePath}]The source file path \item[{\em destFilePath}]The destination file path \end{DoxyParams}
...
\begin{DoxyParams}{Parameters}
\item[{\em options}]the copy options \end{DoxyParams}
...
\begin{DoxyParams}{Parameters}
\item[{\em options}]the move options \end{DoxyParams}
\begin{DoxyReturn}{Returns}
0 if the function succeeds or an error code otherwise 
\end{DoxyReturn}
...
\begin{DoxyParams}{Parameters}
\item[{\em options}]the move file options \end{DoxyParams}
\begin{DoxyReturn}{Returns}
0 if the function succeeds or an error code otherwise 
\end{DoxyReturn}
...
\begin{DoxyParams}{Parameters}
\item[{\em options}]The stop options \end{DoxyParams}
\begin{DoxyReturn}{Returns}
0 if the function succeeds or an error code otherwise 
\end{DoxyReturn}
