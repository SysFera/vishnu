...
\item[{\em session}]The object which encapsulates the session information \item[{\em machineid}]The machine identifier \end{DoxyParams}
...
\begin{DoxyParams}{Parameters}
\item[{\em session}]The object which encapsulates the session information \item[{\em machineid}]The machine identifier \item[{\em jobResult}]The job result data structure \end{DoxyParams}
