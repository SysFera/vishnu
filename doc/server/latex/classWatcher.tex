...
\item[{\em toolType,:}]The type of the tool used by the watcher \item[{\em argc,:}]Argc from main \item[{\em argv,:}]Argv from main \item[{\em mid,:}]The machine Id the watcher is running \end{DoxyParams}
