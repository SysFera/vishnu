...
{\em dbConfig} & the configuration of the database client \\
\hline
\end{DoxyParams}
...
\begin{DoxyParams}{Parameters}
{\em pos} & The position of the connection gotten in the pool \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
...
\begin{DoxyParams}{Parameters}
{\em pos} & The position of the connection to release \\
\hline
\end{DoxyParams}
