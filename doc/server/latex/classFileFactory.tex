...
\item[{\em sessionServer}]the session server object \item[{\em path}]the path of the file \item[{\em user}]the file user \item[{\em key}]the ssh private key path \end{DoxyParams}
...
\begin{DoxyParams}{Parameters}
\item[{\em scpCommand}]the new scp command path \end{DoxyParams}
...
\begin{DoxyParams}{Parameters}
\item[{\em sshCommand}]the new ssh command path \end{DoxyParams}
...
\begin{DoxyParams}{Parameters}
\item[{\em sshServer}]the new ssh server host \end{DoxyParams}
