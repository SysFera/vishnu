...
void \hyperlink{classLLServer_a40380f79a1905b5b660849e9b3d665ff}{fillListOfJobs} (TMS\_\-Data::ListJobs $\ast$\&listOfJobs, const std::vector$<$ string $>$ \&ignoredIds=std::vector$<$ string $>$())
...
int \hyperlink{classLLServer_a96abe5f6fbe6451a8c584f444d162478}{getJobNodeCount} (const std::string \&jobId)
\begin{DoxyCompactList}\small\item\em Function to get the number of nodes of the job. \item\end{DoxyCompactList}\item 
std::string \hyperlink{classLLServer_a1858df223d11dedec38da8010321cf32}{getLLResourceValue} (const char $\ast$file, const std::string \&optionLetterSyntax)
\begin{DoxyCompactList}\small\item\em Function to get the value of LoadLeveler resource (nodes, walltime, cpu) in the script. \item\end{DoxyCompactList}\end{DoxyCompactItemize}
...
VISHNU state 
\end{DoxyReturn}
\hypertarget{classLLServer_a40380f79a1905b5b660849e9b3d665ff}{
\index{LLServer@{LLServer}!fillListOfJobs@{fillListOfJobs}}
\index{fillListOfJobs@{fillListOfJobs}!LLServer@{LLServer}}
\subsubsection[{fillListOfJobs}]{\setlength{\rightskip}{0pt plus 5cm}void LLServer::fillListOfJobs (
\begin{DoxyParamCaption}
\item[{TMS\_\-Data::ListJobs $\ast$\&}]{ listOfJobs, }
\item[{const std::vector$<$ string $>$ \&}]{ ignoredIds = {\ttfamily std::vector$<$~string~$>$()}}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily  \mbox{[}virtual\mbox{]}}}}
\label{classLLServer_a40380f79a1905b5b660849e9b3d665ff}
...
\hypertarget{classLLServer_a96abe5f6fbe6451a8c584f444d162478}{
\index{LLServer@{LLServer}!getJobNodeCount@{getJobNodeCount}}
\index{getJobNodeCount@{getJobNodeCount}!LLServer@{LLServer}}
\subsubsection[{getJobNodeCount}]{\setlength{\rightskip}{0pt plus 5cm}int LLServer::getJobNodeCount (
\begin{DoxyParamCaption}
\item[{const std::string \&}]{ jobId}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily  \mbox{[}private\mbox{]}}}}
\label{classLLServer_a96abe5f6fbe6451a8c584f444d162478}


Function to get the number of nodes of the job. 
...
\hypertarget{classLLServer_a1858df223d11dedec38da8010321cf32}{
\index{LLServer@{LLServer}!getLLResourceValue@{getLLResourceValue}}
\index{getLLResourceValue@{getLLResourceValue}!LLServer@{LLServer}}
\subsubsection[{getLLResourceValue}]{\setlength{\rightskip}{0pt plus 5cm}std::string LLServer::getLLResourceValue (
\begin{DoxyParamCaption}
\item[{const char $\ast$}]{ file, }
\item[{const std::string \&}]{ optionLetterSyntax}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily  \mbox{[}private\mbox{]}}}}
\label{classLLServer_a1858df223d11dedec38da8010321cf32}


Function to get the value of LoadLeveler resource (nodes, walltime, cpu) in the script. 


\begin{DoxyParams}{Parameters}
\item[{\em file}]The file contain the script to scan \item[{\em optionLetterSyntax}]The syntax of the option (nodes, walltime, cpu) whose value will be returned \end{DoxyParams}
\begin{DoxyReturn}{Returns}
