...
\begin{DoxyCompactList}\small\item\em Function to get the number of nodes of the job. \item\end{DoxyCompactList}\end{DoxyCompactItemize}
...
\begin{DoxyParams}{Parameters}
{\em run} & contains the number of running jobs of each queue \\
\hline
{\em que} & contains the number of waiting jobs of each queue \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
raises an exception on error 
...
\begin{DoxyParams}{Parameters}
{\em optionLineToInsert} & the option to insert \\
\hline
{\em content} & The buffer containing the inserted option \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
raises an exception on error 
