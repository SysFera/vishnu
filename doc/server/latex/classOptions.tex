...
{\em name} & the name of the command which uses the option \\
\hline
\end{DoxyParams}
...
\hline
{\em desc,:} & brief description of the option \\
\hline
{\em group,:} & a group which option belongs to \\
\hline
\end{DoxyParams}
...
{\em group,:} & a group which option belongs to \\
\hline
{\em userFunc,:} & The user defined function (callback) command line \\
\hline
{\em required,:} & for required option \\
\hline
\end{DoxyParams}
...
{\em group,:} & a group which option belongs to \\
\hline
{\em value,:} & the value of the option when option is provided in command line \\
\hline
{\em required,:} & for required option \\
\hline
\end{DoxyParams}
...
\begin{DoxyParams}{Parameters}
{\em ac,:} & The number of parameters of the command \\
\hline
{\em av,:} & the names of all paramters \\
\hline
\end{DoxyParams}
...
\begin{DoxyParams}{Parameters}
{\em name\_\-mapper,:} & a functor providing a simple name from the conventional name of the environment variable Ex: for VISHNU\_\-CONFIG\_\-FILE, it returns dietConfig \\
\hline
\end{DoxyParams}
...
\begin{DoxyParams}{Parameters}
{\em tmp\_\-options,:} & the set of options to group \\
\hline
{\em group} & : the group to set \\
\hline
\end{DoxyParams}
...
\begin{DoxyParams}{Parameters}
{\em os,:} & Where options wiil be printed. \\
\hline
{\em opt,:} & the options to print. \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
