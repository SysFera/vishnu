...
\hypertarget{classTorqueServer_a78dc1909e07eaf03854d423696b30c4e}{
...
\label{classTorqueServer_a78dc1909e07eaf03854d423696b30c4e}
...
\begin{DoxyParams}{Parameters}
\item[{\em nextNodeContent}]The node content to parse \item[{\em ppn}]The syntaxe containing the number of processors per node \item[{\em nbNodes}]The computed number of nodes \item[{\em nbCpu}]The numbers of cpus \end{DoxyParams}
...
\begin{DoxyParams}{Parameters}
\item[{\em format}]The node format \item[{\em nbCpu}]The minimum number of cpu per node \end{DoxyParams}
\begin{DoxyReturn}{Returns}
the number of node 
\end{DoxyReturn}
