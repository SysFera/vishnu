...
\begin{DoxyParams}{Parameters}
\item[{\em remoteServer}]the name of the remote server \item[{\em isLocal}]is the remoteServer is local \end{DoxyParams}
\begin{DoxyReturn}{Returns}
raises an exception on error 
\end{DoxyReturn}
...
\index{TorqueServer@{TorqueServer}!serverOut@{serverOut}}
\index{serverOut@{serverOut}!TorqueServer@{TorqueServer}}
\subsubsection[{serverOut}]{\setlength{\rightskip}{0pt plus 5cm}char {\bf TorqueServer::serverOut}\mbox{[}PBS\_\-MAXSERVERNAME+PBS\_\-MAXPORTNUM+2\mbox{]}\hspace{0.3cm}{\ttfamily  \mbox{[}private\mbox{]}}}}
