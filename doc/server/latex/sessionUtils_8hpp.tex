...
void \hyperlink{sessionUtils_8hpp_a5823721c5d9b9536fddcc416fc393b08}{storeLastSession} (const UMS\_\-Data::Session \&session\_\-, int ppid)
...
std::string \hyperlink{sessionUtils_8hpp_a3e08c9dbbe17b84c4f39bcdce20b5e43}{getLastSessionId} (int ppid)
\begin{DoxyCompactList}\small\item\em To get the last session identifier. \item\end{DoxyCompactList}\item 
...
{\em e,:} & a given \hyperlink{classVishnuException}{VishnuException} \\
\hline
\end{DoxyParams}
...
\begin{DoxyParams}{Parameters}
{\em terminal,:} & the file corresponding to the terminal which launched the serialization process \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
...
\begin{DoxyParams}{Parameters}
{\em allSessions,:} & The sessions stored in the file \\
\hline
{\em file} & : The file storing the sessions \\
\hline
\end{DoxyParams}

\begin{DoxyExceptions}{Exceptions}
{\em :} & raises a Boost archive exception \\
\hline
\end{DoxyExceptions}
...
\begin{DoxyParams}{Parameters}
{\em terminal} & : The terminal in which the session was running \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
The last stored session 
\end{DoxyReturn}
\hypertarget{sessionUtils_8hpp_a3e08c9dbbe17b84c4f39bcdce20b5e43}{
\index{sessionUtils.hpp@{sessionUtils.hpp}!getLastSessionId@{getLastSessionId}}
\index{getLastSessionId@{getLastSessionId}!sessionUtils.hpp@{sessionUtils.hpp}}
\subsubsection[{getLastSessionId}]{\setlength{\rightskip}{0pt plus 5cm}std::string getLastSessionId (
\begin{DoxyParamCaption}
\item[{int}]{ppid}
\end{DoxyParamCaption}
)}}
\label{sessionUtils_8hpp_a3e08c9dbbe17b84c4f39bcdce20b5e43}


To get the last session identifier. 


\begin{DoxyParams}{Parameters}
{\em ppid,:} & The identifier of the terminal as process in which the session had been open \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
The identifier of the last session open from the terminal 
\end{DoxyReturn}
...
\begin{DoxyParams}{Parameters}
{\em tpid} & : the identifier of the terminal as process \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
...
\begin{DoxyParams}{Parameters}
{\em ppid} & : The process identifier of the terminal in which the session had been open. \\
\hline
\end{DoxyParams}
...
\begin{DoxyParams}{Parameters}
{\em allSessions,:} & A set of sessions which will be stored in the file \\
\hline
{\em file} & : the path of the file \\
\hline
\end{DoxyParams}
...
\begin{DoxyParams}{Parameters}
{\em sessionKey,:} & The key of the session which will be stored \\
\hline
{\em closePolicy,:} & The session close type \\
\hline
{\em ppid,:} & The identifier of the terminal as process \\
\hline
\end{DoxyParams}
...
\begin{DoxyParams}{Parameters}
{\em session} & : the current session \\
\hline
{\em terminal,:} & The terminal in which the session is running \\
\hline
\end{DoxyParams}
\hypertarget{sessionUtils_8hpp_a5823721c5d9b9536fddcc416fc393b08}{
\index{sessionUtils.hpp@{sessionUtils.hpp}!storeLastSession@{storeLastSession}}
\index{storeLastSession@{storeLastSession}!sessionUtils.hpp@{sessionUtils.hpp}}
\subsubsection[{storeLastSession}]{\setlength{\rightskip}{0pt plus 5cm}void storeLastSession (
\begin{DoxyParamCaption}
\item[{const UMS\_\-Data::Session \&}]{session\_\-, }
\item[{int}]{ppid}
\end{DoxyParamCaption}
)}}
\label{sessionUtils_8hpp_a5823721c5d9b9536fddcc416fc393b08}
...
\begin{DoxyParams}{Parameters}
{\em session\_\-,:} & The session which will be stored \\
\hline
{\em ppid,:} & The identifier of the terminal as process \\
\hline
\end{DoxyParams}
