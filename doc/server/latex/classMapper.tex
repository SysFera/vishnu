...
\begin{DoxyParams}{Parameters}
{\em key} & The entry in the map to get an remove \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
...
\begin{DoxyParams}{Parameters}
{\em s} & The string to find the separator \\
\hline
{\em vec} & A vector containing the position of the separator in the string s (OUT) \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
