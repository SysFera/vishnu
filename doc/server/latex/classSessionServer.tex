...
{\em sessionKey} & The session key of the session \\
\hline
\end{DoxyParams}
...
\begin{DoxyParams}{Parameters}
{\em session} & The session data structure \\
\hline
\end{DoxyParams}


\subsection{Member Function Documentation}
\hypertarget{classSessionServer_a97647ee61a04b91e9b220fb0700910b7}{
\index{SessionServer@{SessionServer}!check@{check}}
\index{check@{check}!SessionServer@{SessionServer}}
\subsubsection[{check}]{\setlength{\rightskip}{0pt plus 5cm}int SessionServer::check (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
)}}
\label{classSessionServer_a97647ee61a04b91e9b220fb0700910b7}


Function to make a complete checking of the session key. 
...
\begin{DoxyParams}{Parameters}
{\em user} & The object which manipulates user information \\
\hline
{\em host} & The object which manipulates client machine information \\
\hline
{\em connectOpt} & The options data structure for connection \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
raises an exception on error 
...
\begin{DoxyParams}{Parameters}
{\em flagSessionId} & A flag to check the session id \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
true if the session key (or sessionId) exists else false 
\end{DoxyReturn}
\hypertarget{classSessionServer_ab1a59010af4f2e4f9ad19c078a38e1b0}{
\index{SessionServer@{SessionServer}!finish@{finish}}
\index{finish@{finish}!SessionServer@{SessionServer}}
\subsubsection[{finish}]{\setlength{\rightskip}{0pt plus 5cm}int SessionServer::finish (
\begin{DoxyParamCaption}
\item[{std::string}]{cmdDescription, }
\item[{{\bf CmdType}}]{cmdType, }
\item[{{\bf CmdStatus}}]{cmdStatus, }
\item[{std::string}]{newVishnuObjectID = {\ttfamily \char`\"{}\char`\"{}}}
\end{DoxyParamCaption}
)}}
\label{classSessionServer_ab1a59010af4f2e4f9ad19c078a38e1b0}


Function to finalize the service. 


\begin{DoxyParams}{Parameters}
{\em cmdDescription} & The description of the command \\
\hline
...
\begin{DoxyParams}{Parameters}
{\em userId} & the userId of the owner of the session \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
...
\begin{DoxyParams}{Parameters}
{\em idmachine} & the database number id of the client machine \\
\hline
{\em iduser} & the database number id of the owner of the session \\
\hline
{\em flagAdmin} & A flag for an admin to get the session key from another user \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
...
\begin{DoxyParams}{Parameters}
{\em flagSessionId} & A flag to check the session identifier \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
the session status 
