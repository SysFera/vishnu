...
\begin{DoxyParams}{Parameters}
\item[{\em cmdDescription}]The description of the command \item[{\em cmdType}]The type of the command (UMS, TMS, FMS, IMS) \item[{\em cmdStatus}]The status of the command \item[{\em newVishnuObjectID}]the new vishnu object Id \end{DoxyParams}
\begin{DoxyReturn}{Returns}
raises an exception on error 
\end{DoxyReturn}
