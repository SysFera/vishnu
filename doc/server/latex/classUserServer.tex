...
{\em userId} & The userId of the user \\
\hline
...
\begin{DoxyParams}{Parameters}
{\em user} & The user data structure \\
\hline
\end{DoxyParams}
...
\begin{DoxyParams}{Parameters}
{\em sessionServer} & The object to manipulate session \\
\hline
\end{DoxyParams}
...
\begin{DoxyParams}{Parameters}
{\em newPassword} & The new password of the user \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
raises an exception on error 
...
\begin{DoxyParams}{Parameters}
{\em flagForChangePwd} & A flag to check the password state \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
...
\begin{DoxyParams}{Parameters}
{\em value1} & a string used to generate the password \\
\hline
{\em value2} & a string used to generate the password \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
...
\begin{DoxyParams}{Parameters}
{\em user} & the user who will receives the email \\
\hline
{\em flagAdduser} & a flag which means that it is uses on adduser function \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
the email content 
...
\begin{DoxyParams}{Parameters}
{\em machineId} & The machine identifier of machine on which the user have a account \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
...
\begin{DoxyParams}{Parameters}
{\em attributName} & The name of the attribut to check \\
\hline
{\em valueOk} & the value which will be compare to attribut name value \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
...
\begin{DoxyParams}{Parameters}
{\em user} & the user to whom send the email \\
\hline
{\em content} & the body of the email \\
\hline
