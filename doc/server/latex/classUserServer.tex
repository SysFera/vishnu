...
raises an exception on error 
\end{DoxyReturn}
\hypertarget{classUserServer_aeba9bcdce19abb3b8f73b217efb60352}{
\index{UserServer@{UserServer}!CheckUserState@{CheckUserState}}
\index{CheckUserState@{CheckUserState}!UserServer@{UserServer}}
\subsubsection[{CheckUserState}]{\setlength{\rightskip}{0pt plus 5cm}void UserServer::CheckUserState (
\begin{DoxyParamCaption}
\item[{bool}]{ flagForChangePwd}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily  \mbox{[}private\mbox{]}}}}
\label{classUserServer_aeba9bcdce19abb3b8f73b217efb60352}


Function to check the user state (locked or not) and to verify the password state. 
...
\end{DoxyReturn}
\hypertarget{classUserServer_a42f6a347a80bcf6806c8f944f66cc713}{
\index{UserServer@{UserServer}!isAuthenticate@{isAuthenticate}}
\index{isAuthenticate@{isAuthenticate}!UserServer@{UserServer}}
\subsubsection[{isAuthenticate}]{\setlength{\rightskip}{0pt plus 5cm}bool UserServer::isAuthenticate (
\begin{DoxyParamCaption}
\item[{bool}]{ flagForChangePwd = {\ttfamily false}}
\end{DoxyParamCaption}
)}}
\label{classUserServer_a42f6a347a80bcf6806c8f944f66cc713}


Function to authenticate user by using an authentification system. 
