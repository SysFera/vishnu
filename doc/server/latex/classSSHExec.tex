...
\item[{\em sshCommand}]the ssh command path \item[{\em scpCommand}]the scp command path \item[{\em server}]the ssh host \item[{\em sshPort}]the ssh port \item[{\em userName}]the ssh user \item[{\em password}]the ssh password \item[{\em publicKey}]the ssh public key \item[{\em privateKey}]the ssh private key \end{DoxyParams}
...
\begin{DoxyParams}{Parameters}
\item[{\em cmd}]the command to perform \end{DoxyParams}
...
\begin{DoxyParams}{Parameters}
\item[{\em processId}]the new execution process identifier \end{DoxyParams}
