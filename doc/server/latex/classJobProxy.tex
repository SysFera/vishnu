...
\item[{\em session}]The object which encapsulates the session information \item[{\em machineId}]The id of the machine \item[{\em job}]The job data structure \end{DoxyParams}
...
\begin{DoxyParams}{Parameters}
\item[{\em options}]the options to submit job \end{DoxyParams}
\begin{DoxyReturn}{Returns}
raises an exception on error 
\end{DoxyReturn}
