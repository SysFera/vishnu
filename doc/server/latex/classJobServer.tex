...
\item[{\em session}]The object which encapsulates the session information \item[{\em machineid}]The machine identifier \item[{\em job}]The job data structure \end{DoxyParams}
...
\begin{DoxyParams}{Parameters}
\item[{\em errorInfo}]the error information to scan \item[{\em The}]code The code of the error \item[{\em message}]The message associeted to the error code \end{DoxyParams}
\begin{DoxyReturn}{Returns}
