...
\item[{\em src}]The source \item[{\em dest}]The destination \item[{\em transferInfo}]The file transfer complete information \item[{\em cpFileOptions}]The file transfer options \end{DoxyParams}
