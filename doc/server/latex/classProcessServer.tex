...
{\em proc,:} & The process that has just been authentified \\
\hline
\end{DoxyParams}
...
\begin{DoxyParams}{Parameters}
{\em machine,:} & The vishnu machine id \\
\hline
...
\begin{DoxyParams}{Parameters}
{\em proc,:} & The process that has just connected \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
Success, an error code otherwise 
...
\begin{DoxyParams}{Parameters}
{\em proc,:} & The process that has just disconnected \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
Success, an error code otherwise 
...
\begin{DoxyParams}{Parameters}
{\em mmid,:} & Vishnu machine id \\
\hline
{\em hostname,:} & hostname of the machine \\
\hline
{\em acclog,:} & Account login of the user 'root' on the machine \\
\hline
\end{DoxyParams}
...
\begin{DoxyParams}{Parameters}
{\em proc,:} & The proc down to flag as stopped (means restarted) \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
Success, an error code otherwise 
...
\begin{DoxyParams}{Parameters}
{\em proc,:} & The proc to flag as stopped \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
Success, an error code otherwise 
