...
\item[{\em sessionServer}]the session object server \item[{\em path}]the path of the file \item[{\em sshHost}]the ssh host \item[{\em sshUser}]the ssh user \item[{\em sshPublicKey}]the ssh public key \item[{\em sshPrivateKey}]the ssh private key \item[{\em sshPassword}]the ssh password \item[{\em sshPort}]the ssh port \item[{\em sshCommand}]the ssh command path \item[{\em scpCommand}]the scp command path \end{DoxyParams}
...
\begin{DoxyParams}{Parameters}
\item[{\em options}]The file deletion options \end{DoxyParams}
\begin{DoxyReturn}{Returns}
0 if the command succeeds, an error code otherwise 
\end{DoxyReturn}
