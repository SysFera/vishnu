...
\begin{DoxyParams}{Parameters}
\item[{\em vishnuId}]The password of the root user vishnu\_\-user for the connection with the database \item[{\em dbConfig}]The configuration of the database \item[{\em machineId}]The machine identifier \item[{\em batchType}]The batch scheduler type \end{DoxyParams}
