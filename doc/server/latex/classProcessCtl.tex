...
\hypertarget{classProcessCtl_a4a3c0f9f5ad25f02745b37abc7c33778}{
\index{ProcessCtl@{ProcessCtl}!createFile@{createFile}}
\index{createFile@{createFile}!ProcessCtl@{ProcessCtl}}
\subsubsection[{createFile}]{\setlength{\rightskip}{0pt plus 5cm}void ProcessCtl::createFile (
...
\label{classProcessCtl_a4a3c0f9f5ad25f02745b37abc7c33778}


To create the file for the restart function. 


\begin{DoxyParams}{Parameters}
\item[{\em dest,:}]The destination file (inout) \item[{\em p,:}]The process containing the script \item[{\em loc,:}]If the process is local \end{DoxyParams}
...
\begin{DoxyParams}{Parameters}
\item[{\em type,:}]The type of loadShedding \end{DoxyParams}
