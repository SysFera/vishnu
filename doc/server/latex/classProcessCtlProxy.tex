...
\begin{DoxyParams}{Parameters}
{\em loadShedType} & the type of the load shedding mode (SOFT or HARD) \\
\hline
\end{DoxyParams}
...
\begin{DoxyParams}{Parameters}
{\em options} & the options for the restart \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
raises an exception on error 
...
\begin{DoxyParams}{Parameters}
{\em process} & The data structure containing information about the process to stop \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
raises an exception on error 
