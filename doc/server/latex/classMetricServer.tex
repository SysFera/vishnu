...
{\em session,:} & A session to use for the call \\
\hline
{\em op,:} & \hyperlink{classOptions}{Options} for the get metric history call \\
\hline
{\em mail,:} & The script to send mails \\
\hline
\end{DoxyParams}
...
{\em session,:} & A session to use for the call \\
\hline
{\em op,:} & \hyperlink{classOptions}{Options} for the get current metric value call \\
\hline
{\em mail,:} & The script to send mails \\
\hline
\end{DoxyParams}
...
\begin{DoxyParams}{Parameters}
{\em set,:} & A list containing the monitored \\
\hline
{\em mid,:} & The machine id of the machine to add the set \\
\hline
\end{DoxyParams}
...
\begin{DoxyParams}{Parameters}
{\em machineId,:} & The vishnu id of the machine \\
\hline
\end{DoxyParams}
...
\begin{DoxyParams}{Parameters}
{\em val,:} & The value of the metric \\
\hline
{\em threshold,:} & The value of the threshold \\
\hline
{\em type,:} & The type of the threshold \\
\hline
{\em email,:} & The email adress \\
\hline
{\em uid,:} & The user id of the user target \\
\hline
{\em mid,:} & The machine id of the machine where the threshold is reached \\
\hline
\end{DoxyParams}
