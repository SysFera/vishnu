...
\hline
{\em pathInfo} & The information on path to print \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
an error message 
...
\hline
{\em jobId,:} & The identifier of the job to load \\
\hline
\end{DoxyParams}
...
\begin{DoxyParams}{Parameters}
{\em path} & The path containing the job symbol \\
\hline
\end{DoxyParams}
...
\hline
{\em envp} & The list of environment variables used by Slurm submission function \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
raises an exception on error 
