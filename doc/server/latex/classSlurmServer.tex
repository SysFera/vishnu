...
void \hyperlink{classSlurmServer_a303b5f20541943052dd850e5f02da0c6}{fillListOfJobs} (TMS\_\-Data::ListJobs $\ast$\&listOfJobs, const std::vector$<$ string $>$ \&ignoredIds=std::vector$<$ string $>$())
...
\hypertarget{classSlurmServer_a303b5f20541943052dd850e5f02da0c6}{
\index{SlurmServer@{SlurmServer}!fillListOfJobs@{fillListOfJobs}}
\index{fillListOfJobs@{fillListOfJobs}!SlurmServer@{SlurmServer}}
\subsubsection[{fillListOfJobs}]{\setlength{\rightskip}{0pt plus 5cm}void SlurmServer::fillListOfJobs (
\begin{DoxyParamCaption}
\item[{TMS\_\-Data::ListJobs $\ast$\&}]{ listOfJobs, }
\item[{const std::vector$<$ string $>$ \&}]{ ignoredIds = {\ttfamily std::vector$<$~string~$>$()}}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily  \mbox{[}virtual\mbox{]}}}}
\label{classSlurmServer_a303b5f20541943052dd850e5f02da0c6}
...
\hypertarget{classSlurmServer_ae3b9ae057e244c1fe1e471916af30c98}{
\index{SlurmServer@{SlurmServer}!getSlurmResourceValue@{getSlurmResourceValue}}
\index{getSlurmResourceValue@{getSlurmResourceValue}!SlurmServer@{SlurmServer}}
\subsubsection[{getSlurmResourceValue}]{\setlength{\rightskip}{0pt plus 5cm}std::string SlurmServer::getSlurmResourceValue (
\begin{DoxyParamCaption}
\item[{const char $\ast$}]{ file, }
\item[{const std::string \&}]{ shortOptionLetterSyntax, }
\item[{const std::string \&}]{ longOptionLetterSyntax}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily  \mbox{[}private\mbox{]}}}}
\label{classSlurmServer_ae3b9ae057e244c1fe1e471916af30c98}


Function to get the value of SLURM resource (nodes, walltime, cpu) in the script. 


\begin{DoxyParams}{Parameters}
\item[{\em file}]The file contain the script to scan \item[{\em shortOptionLetterSyntax}]The syntax of the short option (-\/-\/N, -\/t) whose value will be returned \item[{\em longOptionLetterSyntax}]The syntax of the long option (-\/-\/nodes, -\/-\/time) whose value will be returned \end{DoxyParams}
\begin{DoxyReturn}{Returns}
...
\hypertarget{classSlurmServer_afc45d1d7b21372d0eb47a8e2577aa861}{
...
\label{classSlurmServer_afc45d1d7b21372d0eb47a8e2577aa861}
