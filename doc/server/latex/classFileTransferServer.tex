...
\hline
{\em vishnuId} & The vishnu instance identifier \\
\hline
\end{DoxyParams}
...
{\em sessionServer} & a session server object \\
\hline
{\em srcHost} & the source host \\
\hline
{\em destHost} & the destination host \\
\hline
...
\hline
{\em srcMachineName} & the source host \\
\hline
...
\hline
{\em value} & the option value \\
\hline
{\em request} & the sql request to modify \\
\hline
\end{DoxyParams}
...
\begin{DoxyParams}{Parameters}
{\em outputMsg} & the output message \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
...
\begin{DoxyParams}{Parameters}
{\em transferExec} & the information about the transfer \\
\hline
{\em trCmd} & the transfer command \\
\hline
\end{DoxyParams}
...
\begin{DoxyParams}{Parameters}
{\em toFilter} & the string to filter \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
The cleaned string 
...
\begin{DoxyParams}{Parameters}
{\em name} & to store the client machine name \\
\hline
{\em userId} & to store the userId \\
\hline
\end{DoxyParams}
...
\begin{DoxyParams}{Parameters}
{\em processId} & the transfer process identifier \\
\hline
{\em errorMsg} & the eventual file transfer execution error message \\
\hline
\end{DoxyParams}
...
\begin{DoxyParams}{Parameters}
{\em fileTransfer} & The new file transfer information \\
\hline
\end{DoxyParams}
...
\begin{DoxyParams}{Parameters}
{\em sshCommand} & The new ssh command \\
\hline
\end{DoxyParams}
...
{\em transferid} & the transfer identifier \\
\hline
{\em pid} & the transfer process identifier \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
...
\begin{DoxyParams}{Parameters}
{\em options} & the stop file transfer options \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
0 if the service succeeds or an error code otherwise 
...
\begin{DoxyParams}{Parameters}
{\em status} & the last execution status \\
\hline
{\em transferId} & the transfer identifier \\
\hline
{\em errorMsg} & the eventual file transfer execution error message \\
