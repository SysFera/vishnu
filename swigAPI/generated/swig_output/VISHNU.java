...
public class VISHNU {
  ...
  public static int submitJob(String sessionKey, String scriptFilePath, Job jobInfo, SubmitOptions options) throws InternalTMSException {
    return VISHNUJNI.submitJob(sessionKey, scriptFilePath, Job.getCPtr(jobInfo), jobInfo, SubmitOptions.getCPtr(options), options);
  }
  ...
  public static int getJobInfo(String sessionKey, String jobId, String machineId, Job jobInfos) throws InternalTMSException {
    return VISHNUJNI.getJobInfo(sessionKey, jobId, machineId, Job.getCPtr(jobInfos), jobInfos);
  }

  public static int listJobs(String sessionKey, ListJobs listOfJobs, ListJobsOptions options) throws InternalTMSException {
    return VISHNUJNI.listJobs(sessionKey, ListJobs.getCPtr(listOfJobs), listOfJobs, ListJobsOptions.getCPtr(options), options);
  }

  public static int getJobProgress(String sessionKey, ListProgression listOfProgress, ProgressOptions options) throws InternalTMSException {
    return VISHNUJNI.getJobProgress(sessionKey, ListProgression.getCPtr(listOfProgress), listOfProgress, ProgressOptions.getCPtr(options), options);
  }
  ...
  public static int getJobOutput(String sessionKey, String jobId, JobResult outputInfo, SWIGTYPE_p_TMS_Data__JobOutputOptions options) throws InternalTMSException {
    return VISHNUJNI.getJobOutput(sessionKey, jobId, JobResult.getCPtr(outputInfo), outputInfo, SWIGTYPE_p_TMS_Data__JobOutputOptions.getCPtr(options));
  }

  public static int getCompletedJobsOutput(String sessionKey, ListJobResults listOfResults, SWIGTYPE_p_TMS_Data__JobOutputOptions options) throws InternalTMSException {
    return VISHNUJNI.getCompletedJobsOutput(sessionKey, ListJobResults.getCPtr(listOfResults), listOfResults, SWIGTYPE_p_TMS_Data__JobOutputOptions.getCPtr(options));
  }
  ...
  public static int cat(String sessionKey, String path, java.lang.String[] contentOfFile) throws InternalFMSException {
    return VISHNUJNI.cat(sessionKey, path, contentOfFile);
  }
