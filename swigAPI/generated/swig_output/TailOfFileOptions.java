...
public class TailOfFileOptions extends EObject {
  ...
  protected TailOfFileOptions(long cPtr, boolean cMemoryOwn) {
    super(VISHNUJNI.SWIGTailOfFileOptionsUpcast(cPtr), cMemoryOwn);
    swigCPtr = cPtr;
  }

  protected static long getCPtr(TailOfFileOptions obj) {
