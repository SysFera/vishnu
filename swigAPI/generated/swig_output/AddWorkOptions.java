...
public class AddWorkOptions extends EObject {
  ...
  public AddWorkOptions(long cPtr, boolean cMemoryOwn) {
    super(VISHNUJNI.AddWorkOptions_SWIGUpcast(cPtr), cMemoryOwn);
    swigCPtr = cPtr;
  }

  public static long getCPtr(AddWorkOptions obj) {
