...
public class ListJobResults extends EObject {
  ...
  protected ListJobResults(long cPtr, boolean cMemoryOwn) {
    super(VISHNUJNI.SWIGListJobResultsUpcast(cPtr), cMemoryOwn);
    swigCPtr = cPtr;
  }

  protected static long getCPtr(ListJobResults obj) {
