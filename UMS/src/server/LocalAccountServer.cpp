  ...
  try {
	...
	if (machineServer.getAttribut("where machineid='"+mlocalAccount->getMachineId()+"'\
	  ...
	  if (!exist(numMachine, numUser)) {  
	    ...
	    std::ifstream ifile (keypath.c_str());
		...
		//TODO: remplir la ssh key ici en allant cherher le contenu dans le fichier ssshpublickey
		...
		throw e;
	      ...
	      UMSVishnuException e (4, "Contact the administrator because an ssh key has been already generated for this account.");
	      throw e;
	    }
