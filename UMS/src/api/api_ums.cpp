...
/**
  ...
  */
int 
connect(const string& userId, const string& password, string& sessionKey, const UMS_Data::ConnectOptions& connectOpt) {
...
/**
  ...
  */
int 
reconnect(const string& userId, const string& password, const string& sessionId, string& sessionKey) {
...
/**
  ...
  */
int 
updateUser(const string& sessionKey, const UMS_Data::User& user) {
...
/**
  ...
  */
int 
deleteUser(const string& sessionKey, const string& userId) {
...
/**
  ...
  */
int
changePassword(const std::string& sessionKey, const std::string& password, const std::string& passwordNew) {
...
/**
  ...
  * \param sessionKey is the encrypted identifier of the session generated by VISHNU
  * \param filePath is the file containing the saving configuration 
...
/**
  ...
  * \param sessionKey is the encrypted identifier of the session generated by VISHNU
  * \param filePath is is the path of the file used to restore VISHNU configuration
  * \return raises an exception on error 
  */
int 
...
/**
  * \brief Function to configures a default option value
