INSERT INTO vishnu("updatefreq", "formatiduser", "formatidjob", "formatidtransfer", "formatidmachine", "usercpt", "jobcpt", "fileSubcpt", "machinecpt") values('100', 'user_$CPT', 'job_$CPT', 'transfer_$CPT', 'machine_$CPT', '2', '2', '2', '2');
