...
/**
 * \file AuthSystems.hpp
 * \brief The AuthSystems class
 * \author Generated file
 * \date 31/03/2011
 */

#ifndef UMS_DATA_AUTHSYSTEMS_HPP
#define UMS_DATA_AUTHSYSTEMS_HPP
...
/*PROTECTED REGION ID(AuthSystems_pre) START*/
...
namespace UMS_Data
{
    ...
    /**
     * \class AuthSystems
     * \brief Implementation of the AuthSystems class
     */
    class AuthSystems: public virtual ::ecore::EObject

    {
    public:
        /**
         * \brief The default constructor for AuthSystems
         */
        AuthSystems();
        /**
         * \brief The destructor for AuthSystems
         */
        virtual ~AuthSystems();
        ...
        /*PROTECTED REGION ID(AuthSystemsImpl) START*/
        // Please, enable the protected region if you add manually written code.
        // To do this, add the keyword ENABLED before START.
        /*PROTECTED REGION END*/
...
#endif // UMS_DATA_AUTHSYSTEMS_HPP
