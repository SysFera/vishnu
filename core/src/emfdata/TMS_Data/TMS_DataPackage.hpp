...
namespace TMS_Data
{
    ...
    public:
        ...
        /**
         * \brief Constant for JOB__STARTDATE feature
         */
        static const int JOB__STARTDATE = 13;
         ...
         */
        static const int JOB__BATCHJOBID = 23;

        /**
         * \brief Constant for JOB__OUTPUTDIR feature
         */
        static const int JOB__OUTPUTDIR = 24;

        /**
         * \brief Constant for JOB__WORKID feature
         */
        static const int JOB__WORKID = 25;
        ...
        /**
         * \brief Returns the reflective object for feature startDate of class Job
         * \return A pointer to the reflective object
         */
        virtual ::ecore::EAttribute_ptr getJob__startDate();
        ...
        /**
         * \brief Returns the reflective object for feature startDate of class Work
         * \return A pointer to the reflective object
         */
        virtual ::ecore::EAttribute_ptr getWork__startDate();
    ...
    protected:
        ...
        /**
         * \brief The instance for the feature startDate of class Job
         */
        ::ecore::EAttribute_ptr m_Job__startDate;
        ...
        /**
         * \brief The instance for the feature startDate of class Work
         */
        ::ecore::EAttribute_ptr m_Work__startDate;
