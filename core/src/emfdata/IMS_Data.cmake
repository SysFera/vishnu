...
set(IMS_Data_SOURCES
    ...
    ${CMAKE_CURRENT_SOURCE_DIR}/IMS_Data/SupervisorOp.cpp
    ${CMAKE_CURRENT_SOURCE_DIR}/IMS_Data/SupervisorOpImpl.cpp
   )
...
set(IMS_Data_HEADERS
    ...
    ${CMAKE_CURRENT_SOURCE_DIR}/IMS_Data/SupervisorOp.hpp
   )

install(FILES ${CMAKE_CURRENT_SOURCE_DIR}/IMS_Data.hpp DESTINATION ${INCLUDE_INSTALL_DIR}/emf4cpp/)
install(FILES ${CMAKE_CURRENT_SOURCE_DIR}/IMS_Data_forward.hpp DESTINATION ${INCLUDE_INSTALL_DIR}/emf4cpp/)
install(FILES ${CMAKE_CURRENT_SOURCE_DIR}/IMS_Data/IMS_DataFactory.hpp DESTINATION ${INCLUDE_INSTALL_DIR}/emf4cpp/IMS_Data)
install(FILES ${CMAKE_CURRENT_SOURCE_DIR}/IMS_Data/IMS_DataPackage.hpp DESTINATION ${INCLUDE_INSTALL_DIR}/emf4cpp/IMS_Data)
install(FILES ${CMAKE_CURRENT_SOURCE_DIR}/IMS_Data/Metric.hpp DESTINATION ${INCLUDE_INSTALL_DIR}/emf4cpp/IMS_Data)
install(FILES ${CMAKE_CURRENT_SOURCE_DIR}/IMS_Data/ListMetric.hpp DESTINATION ${INCLUDE_INSTALL_DIR}/emf4cpp/IMS_Data)
install(FILES ${CMAKE_CURRENT_SOURCE_DIR}/IMS_Data/ListProcesses.hpp DESTINATION ${INCLUDE_INSTALL_DIR}/emf4cpp/IMS_Data)
install(FILES ${CMAKE_CURRENT_SOURCE_DIR}/IMS_Data/SystemInfo.hpp DESTINATION ${INCLUDE_INSTALL_DIR}/emf4cpp/IMS_Data)
install(FILES ${CMAKE_CURRENT_SOURCE_DIR}/IMS_Data/Process.hpp DESTINATION ${INCLUDE_INSTALL_DIR}/emf4cpp/IMS_Data)
install(FILES ${CMAKE_CURRENT_SOURCE_DIR}/IMS_Data/ExportOp.hpp DESTINATION ${INCLUDE_INSTALL_DIR}/emf4cpp/IMS_Data)
install(FILES ${CMAKE_CURRENT_SOURCE_DIR}/IMS_Data/MetricHistOp.hpp DESTINATION ${INCLUDE_INSTALL_DIR}/emf4cpp/IMS_Data)
install(FILES ${CMAKE_CURRENT_SOURCE_DIR}/IMS_Data/CurMetricOp.hpp DESTINATION ${INCLUDE_INSTALL_DIR}/emf4cpp/IMS_Data)
install(FILES ${CMAKE_CURRENT_SOURCE_DIR}/IMS_Data/ProcessOp.hpp DESTINATION ${INCLUDE_INSTALL_DIR}/emf4cpp/IMS_Data)
install(FILES ${CMAKE_CURRENT_SOURCE_DIR}/IMS_Data/ThresholdOp.hpp DESTINATION ${INCLUDE_INSTALL_DIR}/emf4cpp/IMS_Data)
install(FILES ${CMAKE_CURRENT_SOURCE_DIR}/IMS_Data/ListThreshold.hpp DESTINATION ${INCLUDE_INSTALL_DIR}/emf4cpp/IMS_Data)
install(FILES ${CMAKE_CURRENT_SOURCE_DIR}/IMS_Data/Threshold.hpp DESTINATION ${INCLUDE_INSTALL_DIR}/emf4cpp/IMS_Data)
install(FILES ${CMAKE_CURRENT_SOURCE_DIR}/IMS_Data/SysInfoOp.hpp DESTINATION ${INCLUDE_INSTALL_DIR}/emf4cpp/IMS_Data)
install(FILES ${CMAKE_CURRENT_SOURCE_DIR}/IMS_Data/ListSysInfo.hpp DESTINATION ${INCLUDE_INSTALL_DIR}/emf4cpp/IMS_Data)
install(FILES ${CMAKE_CURRENT_SOURCE_DIR}/IMS_Data/SupervisorOp.hpp DESTINATION include/emf4cpp/IMS_Data)
...
install(TARGETS emf4cpp-IMS_Data DESTINATION ${LIB_INSTALL_DIR})