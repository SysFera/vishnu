...
namespace vishnu {
  ...
  param_t params[] =
  {
    ...
    /* [21] */ {SED_URIADDR, "sed_uriAddr", URI_PARAMETER},
    /* [22] */ {CLOUDENDPOINT, "cloudEndpoint", STRING_PARAMETER},
    /* [23] */ {DEBUG_LEVEL, "debugLevel", INT_PARAMETER},
    /* [24] */ {DB_USE_SSL, "databaseUseSsl", BOOL_PARAMETER},
    /* [25] */ {DB_SSL_CA_FILE, "databaseSslCa", STRING_PARAMETER},
    /* [26] */ {USE_SSL, "useSsl", BOOL_PARAMETER},
    /* [27] */ {SERVER_PUBLIC_KEY, "serverPublicKey", STRING_PARAMETER},
    /* [28] */ {SERVER_PRIVATE_KEY, "serverPrivateKey", STRING_PARAMETER},
    /* [29] */ {SERVER_SSL_CERTICATE, "serverSslCertificate", STRING_PARAMETER},
    /* [30] */ {SSL_CA, "sslCa", STRING_PARAMETER},
    /* [31] */ {SUBSCRIBE, "subscribe", BOOL_PARAMETER},
    /* [32] */ {STANDALONE, "standalone", BOOL_PARAMETER},
    /* [33] */ {HAS_UMS, "enableUMS", BOOL_PARAMETER},
    /* [34] */ {HAS_TMS, "enableTMS", BOOL_PARAMETER}
  };
