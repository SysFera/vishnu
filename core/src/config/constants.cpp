...
namespace vishnu {
  ...
  std::map<cloud_env_vars_t, std::string> CLOUD_ENV_VARS =  boost::assign::map_list_of
                                                            ...
                                                            (CLOUD_VM_IMAGE_0, "VISHNU_CLOUD_VM_IMAGE_0")
                                                            (CLOUD_VM_IMAGE_1, "VISHNU_CLOUD_VM_IMAGE_1")
                                                            (CLOUD_VM_IMAGE_ARCH_0, "VISHNU_CLOUD_VM_IMAGE_ARCH_0")
                                                            (CLOUD_VM_IMAGE_ARCH_1, "VISHNU_CLOUD_VM_IMAGE_ARCH_1")
