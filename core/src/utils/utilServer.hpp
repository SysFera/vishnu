...
namespace vishnu {
  ...
  */
   ...
   */
  bool
  checkObjectId(const std::string& table,
   ...
   */
  int
  getVishnuCounter(const std::string& vishnuId, IdType type);
   ...
   */
  std::string
  getAttrVishnu(const std::string& attrname, const std::string& vishnuid, int transacId = -1);
   ...
   */
  void
  incrementCpt(const std::string& cptName, int cpt, int transacId = -1);
