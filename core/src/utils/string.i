...
// string.i
//
// Typemaps for std::string& in Java
// These are mapped to an array of strings to overcome
// the limitation of passing by value.
// To use the typemap use the following apply:
