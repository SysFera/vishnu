    ...
    m_eContainingClass(0)
{
    ...
    m_eTypeParameters.reset(new ::ecorecpp::mapping::ReferenceEListImpl<
            ::ecore::ETypeParameter, -1, true, false >(this, NULL));
    m_eParameters.reset(new ::ecorecpp::mapping::ReferenceEListImpl<
            ::ecore::EParameter, -1, true, true >(this, NULL));
    m_eExceptions.reset(new ::ecorecpp::mapping::ReferenceEListImpl<
            ::ecore::EClassifier, -1, false, false >(this, NULL));
    m_eGenericExceptions.reset(new ::ecorecpp::mapping::ReferenceEListImpl<
