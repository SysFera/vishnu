    ...
    m_eModelElement(0)
{
    ...
    m_contents.reset(new ::ecorecpp::mapping::ReferenceEListImpl<
            ::ecore::EObject, -1, true, false >(this, NULL));
    m_references.reset(new ::ecorecpp::mapping::ReferenceEListImpl<
            ::ecore::EObject, -1, false, false >(this, NULL));
