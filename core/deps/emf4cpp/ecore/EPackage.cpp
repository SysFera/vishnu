    ...
    m_eFactoryInstance(0), m_eSuperPackage(0)
{
    ...
    m_eClassifiers.reset(new ::ecorecpp::mapping::ReferenceEListImpl<
            ::ecore::EClassifier, -1, true, true >(this, NULL));
    m_eSubpackages.reset(new ::ecorecpp::mapping::ReferenceEListImpl<
            ::ecore::EPackage, -1, true, true >(this, NULL));
