    ...
    m_eIDAttribute(0)
{
    ...
    m_eSuperTypes.reset(new ::ecorecpp::mapping::ReferenceEListImpl<
            ::ecore::EClass, -1, false, false >(this, NULL));
    m_eOperations.reset(new ::ecorecpp::mapping::ReferenceEListImpl<
            ::ecore::EOperation, -1, true, true >(this, NULL));
    m_eAllAttributes.reset(new ::ecorecpp::mapping::ReferenceEListImpl<
            ::ecore::EAttribute, -1, false, false >(this, NULL));
    m_eAllReferences.reset(new ::ecorecpp::mapping::ReferenceEListImpl<
            ::ecore::EReference, -1, false, false >(this, NULL));
    m_eReferences.reset(new ::ecorecpp::mapping::ReferenceEListImpl<
            ::ecore::EReference, -1, false, false >(this, NULL));
    m_eAttributes.reset(new ::ecorecpp::mapping::ReferenceEListImpl<
            ::ecore::EAttribute, -1, false, false >(this, NULL));
    m_eAllContainments.reset(new ::ecorecpp::mapping::ReferenceEListImpl<
            ::ecore::EReference, -1, false, false >(this, NULL));
    m_eAllOperations.reset(new ::ecorecpp::mapping::ReferenceEListImpl<
            ::ecore::EOperation, -1, false, false >(this, NULL));
    m_eAllStructuralFeatures.reset(new ::ecorecpp::mapping::ReferenceEListImpl<
            ::ecore::EStructuralFeature, -1, false, false >(this, NULL));
    m_eAllSuperTypes.reset(new ::ecorecpp::mapping::ReferenceEListImpl<
            ::ecore::EClass, -1, false, false >(this, NULL));
    m_eStructuralFeatures.reset(new ::ecorecpp::mapping::ReferenceEListImpl<
            ::ecore::EStructuralFeature, -1, true, true >(this, NULL));
    m_eGenericSuperTypes.reset(new ::ecorecpp::mapping::ReferenceEListImpl<
            ::ecore::EGenericType, -1, true, false >(this, NULL));
    m_eAllGenericSuperTypes.reset(new ::ecorecpp::mapping::ReferenceEListImpl<
            ::ecore::EGenericType, -1, false, false >(this, NULL));
