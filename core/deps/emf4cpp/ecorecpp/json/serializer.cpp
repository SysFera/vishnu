...
void serializer::create_node(::ecore::EObject_ptr parent_obj,
...
::ecorecpp::mapping::type_traits::string_t serializer::get_reference(
        EObject_ptr from, EObject_ptr to) const
{
    ::ecorecpp::mapping::type_traits::stringstream_t value;
