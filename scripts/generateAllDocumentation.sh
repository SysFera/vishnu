...
# - UMS, FMS and TMS design doc
# - UMS, FMS and TMS test reports
# - UMS, FMS and TMS test plan
# - manpages
if [[ ! -f copyright ]]; then
...
# generate UMS, FMS and TMS design doc
...
# generate UMS, FMS and TMS test reports
...
# generate UMS, FMS and TMS test plan
...
generate_doc core/design/docbook/ Technical-Architecture
