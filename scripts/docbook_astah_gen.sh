...
if [ $# -lt 3 ]; then
  echo "Usage: " $0 " <generator_dir> <rootmodeldir> <templatefile>"
  echo " <generator_dir> path to sysfera's git vishnuGenerator containing the docbook generators."
  echo " <rootmodeldir> Directory containing apim and ecore"
  echo " <templatefile> Template file"
  exit 1
fi
...
# NOTE: KEEP 2.0.0, otherwise generation will be wrong for python lists, 2.0.0 makes generator set list as return values
version=2.0.0

java -Dfile.encoding=UTF-8 -classpath $generatorpath/libs/org.eclipse.core.runtime_3.6.0.v20100505.jar:$generatorpath/libs/org.eclipse.emf.ecore.xmi_2.5.0.v20100521-1846.jar:$generatorpath/libs/org.apache.commons.cli_1.0.0.v20080604-1500.jar:$generatorpath/com.sysfera.codegen.api/bin:$generatorpath/com.sysfera.codegen.docbook/bin:$generatorpath/com.sysfera.codegen.docbook/libs/astah-community.jar:$generatorpath/com.sysfera.codegen.docbook/libs/org.kermeta.docbook.jar:$generatorpath/com.sysfera.codegen.docbook/libs/org.eclipse.emf.ecore_2.6.1.v20100914-1218.jar:$generatorpath/com.sysfera.codegen.docbook/libs/org.eclipse.emf.common_2.6.0.v20100914-1218.jar com.sysfera.codegen.docbook.DocBookDocumentGenerator -I $rootmodeldir $templatefile $version
