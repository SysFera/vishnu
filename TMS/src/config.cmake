...
set(UsedBatchServer ${TORQUESERVER}  ${LOADLEVELERSERVER}  ${SLURMSERVER} ${SGESERVER} ${LSFSERVER}  ${PBSPROSERVER} ${PBSPROSERVER})
set(USED_BATCH_INCLUDE_DIR  ${TORQUE_ALL_INCLUDE_DIR}  ${LOADLEVELER_ALL_INCLUDE_DIR}  ${SLURM_ALL_INCLUDE_DIR} ${SGE_ALL_INCLUDE_DIR} ${LSF_ALL_INCLUDE_DIR} ${PBSPRO_ALL_INCLUDE_DIR} ${POSIX_ALL_INCLUDE_DIR})
set(USED_BATCH_LIB ${TORQUE_ALL_LIB_DIR}  ${LOADLEVELER_ALL_LIB_DIR}  ${SLURM_ALL_LIB_DIR} ${SGE_ALL_LIB_DIR} ${LSF_ALL_LIB_DIR} ${PBSPRO_ALL_LIB_DIR} ${POSIX_ALL_LIB_DIR})
